...
virat_image = face_recognition.load_image_file('faces/virat.png')
virat_encoding = face_recognition.face_encodings(virat_image)[0]
msd_image = face_recognition.load_image_file('faces/msd.jpg')
msd_encoding = face_recognition.face_encodings(msd_image)[0]

known_encodings = [virat_encoding, msd_encoding]

known_face_names = ["Virat", "Msd"]
